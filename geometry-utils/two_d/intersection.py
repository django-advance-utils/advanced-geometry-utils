...
class Intersection:
    ...
    def intersect_lines(self, p1, p2, p3, p4):
        if not isinstance(p1, Point2) or not isinstance(p2, Point2) or \
           not isinstance(p3, Point2) or not isinstance(p4, Point2):
            raise TypeError("input to intersect_lines is not a point")
