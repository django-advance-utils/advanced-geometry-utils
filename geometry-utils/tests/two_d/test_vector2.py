...
def test_vector_vector_addition_return_type(test_vector2_1, test_vector2_2):
    assert isinstance(test_vector2_1 + test_vector2_2, Vector2)


def test_vector_float_addition(test_vector2_1):
    with pytest.raises(TypeError):
        return test_vector2_1 + 9.0


def test_vector_vector_addition_arithmetic(test_vector2_1, test_vector2_2):
...
def test_vector_vector_subtraction_return_type(test_vector2_1, test_vector2_2):
    assert isinstance(test_vector2_1 - test_vector2_2, Vector2)


def test_vector_float_subtraction(test_vector2_1):
    with pytest.raises(TypeError):
        return test_vector2_1 - 9.0


def test_vector_vector_subtraction_arithmetic(test_vector2_1, test_vector2_2):
...
def test_vector_vector_multiplication(test_vector2_1, test_vector2_2):
    with pytest.raises(TypeError):
        return test_vector2_1 * test_vector2_2


def test_vector_float_multiplication_return_type(test_vector2_1, test_vector2_2):
    assert isinstance(test_vector2_1 * 9.0, Vector2)


def test_vector_float_multiplication_arithmetic(test_vector2_1):
...
def test_vector_vector_division(test_vector2_1, test_vector2_2):
    with pytest.raises(TypeError):
        return test_vector2_1 / test_vector2_2


def test_vector_float_division(test_vector2_1):
    assert test_vector2_1 / 2.0 == Vector2(0.5, 0.5)


def test_vector_float_division_return_type(test_vector2_1):
    assert isinstance((test_vector2_1 / 9.0), Vector2)
...
def test_vector_vector_equality(test_vector2_1, test_vector2_3):
    assert test_vector2_1 == test_vector2_1
    assert test_vector2_1 == test_vector2_3


def test_vector_vector_inequality(test_vector2_1, test_vector2_2):
...
def test_vector_dot_vector_return_type(test_vector2_1, test_vector2_2):
    assert isinstance(test_vector2_1.dot(test_vector2_2), float)
    assert isinstance(test_vector2_2.dot(test_vector2_1), float)


def test_vector_dot_vector_arithmetic(test_vector2_1, test_vector2_2):
    assert test_vector2_1.dot(test_vector2_2) == 1.0
    assert test_vector2_2.dot(test_vector2_1) == 1.0


def test_vector_cross_vector_return_type(test_vector2_1, test_vector2_2):
...
def test_vector_cross_vector_arithmetic(test_vector2_1, test_vector2_2):
...
def test_vector_length_return_type(test_vector2_1):
    assert isinstance(test_vector2_1.length(), float)


def test_vector_length_arithmetic(test_vector2_1):
    assert test_vector2_1.length() == sqrt(2.0)


def test_vector_normalised_return_type(test_vector2_1):
    assert isinstance(test_vector2_1.normalise(), Vector2)


def test_vector_normalised_arithmetic(test_vector2_1, test_vector2_4):
...
def test_reversed_vector_return_type(test_vector2_1):
    assert isinstance(test_vector2_1, Vector2)


def test_reversed_vector_arithmetic(test_vector2_1, test_vector2_4):
