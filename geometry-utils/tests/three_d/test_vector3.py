...
def test_vector_vector_addition_return_type(test_vector_1, test_vector_2):
    assert isinstance(test_vector_1 + test_vector_2, Vector3)
...
def test_vector_vector_addition_arithmetic(test_vector_1, test_vector_2):
    assert test_vector_1 + test_vector_2 == Vector3(2.0, 1.0, 1.0)
...
def test_vector_vector_subtraction_arithmetic(test_vector_1, test_vector_2):
    assert test_vector_1 - test_vector_2 == Vector3(0.0, 1.0, 1.0)
...
def test_vector_float_multiplication_return_type(test_vector_1, test_vector_2):
    assert isinstance(test_vector_1 * 9.0, Vector3)


def test_vector_float_multiplication_arithmetic(test_vector_1):
    assert test_vector_1 * 2.0 == Vector3(2.0, 2.0, 2.0)
...
def test_vector_float_division(test_vector_1):
    assert test_vector_1 / 2.0 == Vector3(0.5, 0.5, 0.5)
...
def test_vector_cross_vector_return_type(test_vector_1, test_vector_2):
    assert isinstance(test_vector_1.cross(test_vector_2), Vector3)
    assert isinstance(test_vector_2.cross(test_vector_1), Vector3)


def test_vector_cross_vector_arithmetic(test_vector_1, test_vector_2):
    assert test_vector_1.cross(test_vector_2) == Vector3(0.0, 1.0, -1.0)
    assert test_vector_2.cross(test_vector_1) == Vector3(0.0, -1.0, 1.0)
...
def test_vector_length_arithmetic(test_vector_1):
    assert test_vector_1.length() == sqrt(3.0)


def test_vector_normalised_return_type(test_vector_1):
    assert isinstance(test_vector_1.normalise(), Vector3)


def test_vector_normalised_arithmetic(test_vector_1, test_vector_6):
    assert test_vector_1.normalise() == Vector3(1/sqrt(3), 1/sqrt(3), 1/sqrt(3))
    assert test_vector_6.normalise() == test_vector_6
...
def test_reversed_vector_return_type(test_vector_1):
    assert isinstance(test_vector_1, Vector3)


def test_reversed_vector_arithmetic(test_vector_1, test_vector_6):
    assert test_vector_1.reverse() == Vector3(-1.0, -1.0, -1.0)
    assert test_vector_6.reverse() == test_vector_6
