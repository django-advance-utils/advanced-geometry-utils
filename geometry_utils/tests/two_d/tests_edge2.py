...
class TestEdge2(unittest.TestCase):
    ...
    def test_edge2_print_string(self):
        self.assertEqual(test_edge2_1.__str__(), "Edge2(p1:Point2(x:0.00, y:0.00), p2:Point2(x:0.00, y:0.00), "
                                                 "centre:Point2(x:0.00, y:0.00), radius:0.0, clockwise:False, "
                                                 "large:False)")

    def test_edge2_to_edge2_equality(self):
        self.assertEqual(test_edge2_1, Edge2())
    ...
    def test_edge2_get_sweep_angle_return_type(self):
        self.assertIsInstance(test_edge2_1.get_sweep_angle(), float)

    def test_edge2_get_sweep_angle_arithmetic(self):
        self.assertEqual(test_edge2_5.get_sweep_angle(), HALF_PI)

    def test_edge2_point_parametric_return_type(self):
        self.assertIsInstance(test_edge2_1.point_parametric(1.0), Point2)

    def test_edge2_point_parametric_return_result(self):
        self.assertEqual(test_edge2_4.point_parametric(0.0), test_edge2_4.p1)
        self.assertEqual(test_edge2_4.point_parametric(0.5), Point2(1.0, 1.0))
        self.assertEqual(test_edge2_4.point_parametric(1.0), test_edge2_4.p2)
    ...
    def test_edge2_parametric_point_return_type(self):
        self.assertIsInstance(test_edge2_1.parametric_point(Point2(0.0, 0.0)), float)

    def test_edge2_parametric_point_arcs_return_result(self):
        # anticlockwise 10 deg
        e1 = Edge2(test_circle_points_1[10], test_circle_points_1[0], 600.0, False, False)

        # endpoints and centre point
        self.assert_(floats_are_close(e1.parametric_point(test_circle_points_1[355]), 1.5))
        self.assert_(floats_are_close(e1.parametric_point(test_circle_points_1[0]), 1.0))
        self.assert_(floats_are_close(e1.parametric_point(test_circle_points_1[5]), 0.5))
        self.assert_(floats_are_close(e1.parametric_point(test_circle_points_1[10]), 0.0))
        self.assert_(floats_are_close(e1.parametric_point(test_circle_points_1[15]), -0.5))

        e2 = Edge2(test_circle_points_1[36], test_circle_points_1[202], 600.0, True, False)

        # endpoints and centre point
        self.assert_(floats_are_close(e2.parametric_point(test_circle_points_1[285]), 1.5))
        self.assert_(floats_are_close(e2.parametric_point(test_circle_points_1[202]), 1.0))
        self.assert_(floats_are_close(e2.parametric_point(test_circle_points_1[119]), 0.5))
        self.assert_(floats_are_close(e2.parametric_point(test_circle_points_1[36]), 0.0))
        self.assert_(floats_are_close(e2.parametric_point(test_circle_points_1[313]), -0.5))

        # large arc
        e3 = Edge2(test_circle_points_1[40], test_circle_points_1[30], 600.0, True, True)

        self.assert_(floats_are_close(e3.parametric_point(test_circle_points_1[30]), 1.0))
        self.assert_(floats_are_close(e3.parametric_point(test_circle_points_1[215]), 0.5))
        self.assert_(floats_are_close(e3.parametric_point(test_circle_points_1[40]), 0.0))

        # clockwise semicircle (large)
        e4 = Edge2(test_circle_points_1[0], test_circle_points_1[180], 600.0, True, True)

        self.assert_(floats_are_close(e4.parametric_point(test_circle_points_1[180]), 1.0))
        self.assert_(floats_are_close(e4.parametric_point(test_circle_points_1[90]), 0.5))
        self.assert_(floats_are_close(e4.parametric_point(test_circle_points_1[0]), 0.0))
        ...
        self.assert_(floats_are_close(e5.parametric_point(test_circle_points_1[180]), 1.0))
        self.assert_(floats_are_close(e5.parametric_point(test_circle_points_1[90]), 0.5))
        self.assert_(floats_are_close(e5.parametric_point(test_circle_points_1[0]), 0.0))

        # anticlockwise semicircle (large)
        e6 = Edge2(test_circle_points_1[180], test_circle_points_1[0], 600.0, False, True)

        self.assert_(floats_are_close(e6.parametric_point(test_circle_points_1[0]), 1.0))
        self.assert_(floats_are_close(e6.parametric_point(test_circle_points_1[90]), 0.5))
        self.assert_(floats_are_close(e6.parametric_point(test_circle_points_1[180]), 0.0))
        ...
        self.assert_(floats_are_close(e7.parametric_point(test_circle_points_1[0]), 1.0))
        self.assert_(floats_are_close(e7.parametric_point(test_circle_points_1[90]), 0.5))
        self.assert_(floats_are_close(e7.parametric_point(test_circle_points_1[180]), 0.0))

    def test_edge2_parametric_point_lines_return_result(self):
        self.assert_(floats_are_close(test_edge2_4.parametric_point(test_edge2_4.p1), 0.0))
        self.assert_(floats_are_close(test_edge2_4.parametric_point(test_edge2_4.p2), 1.0))

    def test_edge2_parametric_point_with_float_argument(self):
        with self.assertRaises(TypeError):
            return test_edge2_1.parametric_point(9.0)

    def test_edge2_get_normal_return_type(self):
        self.assertIsInstance(test_edge2_4.get_normal(Point2(1.0, 1.0)), Vector2)

    def test_edge2_get_normal_arithmetic(self):
        self.assertEqual(test_edge2_6.get_normal(Point2(5.0, 0.0)), Vector2(-1.0, 0.0))
        self.assertEqual(test_edge2_6.get_normal(Point2(0.0, 5.0)), Vector2(0.0, -1.0))

    def test_edge2_get_tangent_arithmetic(self):
        self.assertEqual(test_edge2_4.get_tangent(test_edge2_2.p1), Vector2(2.0 / math.sqrt(8.0), 2.0 / math.sqrt(8.0)))

    def test_edge2_calculate_centre_return_type(self):
        self.assertIsInstance(test_edge2_1.calculate_centre(), Point2)

    def test_edge2_calculate_centre_arithmetic(self):
    ...
    def test_edge2_get_edge_bounds_return_type(self):
        self.assertIsInstance(test_edge2_1.get_edge_bounds(), AxisAlignedBox2)

    def test_edge2_get_edge_bounds_arithmetic(self):
        self.assertEqual(test_edge2_2.get_edge_bounds(), AxisAlignedBox2(Point2(0.0, 0.0), Point2(2.0, 2.0)))

    def test_edge2_offset_edge_arithmetic(self):
    ...
    def test_edge2_reverse(self):
        test_edge_to_be_reversed = Edge2(Point2(1.0, 0.0), Point2(0.0, 1.0))
        reversed_edge = Edge2(Point2(0.0, 1.0), Point2(1.0, 0.0))

        self.assertEqual(test_edge_to_be_reversed.reverse(), reversed_edge)
    ...
    def test_edge2_rotate(self):
        edge_to_be_rotated = Edge2(Point2(0, 0), Point2(1, 0))
    ...
    def test_edge2_parallel_to_edge(self):
        ...
        self.assert_(parallel_edge.is_parallel_to(test_edge2_4))
    ...
    def test_edge2_get_slope(self):
        self.assertEqual(test_edge2_4.get_slope(), 1.0)
    ...
    def test_edge2_minimum_y(self):
        self.assertEqual(test_edge2_4.minimum_y(), 0.0)

    def test_edge2_maximum_y(self):
        self.assertEqual(test_edge2_2.maximum_y(), 2.0)

    def test_edge2_vector_within_arc(self):
        self.assert_(test_edge2_6.vector_within_arc(Vector2(5.0, 0.0)))

    def test_edge2_transform(self):
        ...
        self.assertEqual(edge_to_be_transformed, transformed_edge)
